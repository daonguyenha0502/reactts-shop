        ...
        <div className="w-5/6 sm:w-5/6 md:w-5/6 lg:w-5/6 xl:w-5/6 2xl:w-3/4 text-left mt-20 mx-auto py-4">
            ...
            <div className="mx-auto overflow-y-auto h-1/2 xl:h-5/6 max-w-min mb-4">
                {carts.map((item) => (
                    <div
                        key={item._id}
                        className="w-80 sm:w-100 md:w-120 h-auto border-gray-800 border rounded-lg leading-5 mb-8"
                    >
                        <div className="flex min-h-32">
                            ...
                            <div className="flex-row text-center w-full py-2 relative">
                                ...
                                <p>
                                    Price:{' '}
                                    {(
                                        item.cartAmount * item.price
                                    ).toLocaleString()}{' '}
                                    Đồng
                                </p>
                                <div className="flex w-full justify-center absolute bottom-2"></div>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            <form
                className="flex-col w-min mx-auto justify-center lg:w-full lg:flex-row lg:flex"
            ...
            >
                ...
                <div>
                    ...
                    <label className="font-bold ml-4" htmlFor="city">
                        City{' '}
                    </label>
                    <div className="mb-2 w-92">
                        ...
                        >
                            ...
                            {(listCity as TypeLocationCity[]).map(
                                (itemCity: TypeLocationCity) => (
                                    <option
                                        key={itemCity.MaTP}
                                        value={itemCity.MaTP}
                                    >
                    ...
                    <label className="font-bold ml-4" htmlFor="district">
                        District{' '}
                    </label>
                    <div className="mb-2 w-92">
                        <select
                        ...
                        >
                            ...
                            {(listDistrict as TypeLocationDistrict[]).map(
                                (itemDistrict: TypeLocationDistrict) => (
                                    <option
                                        key={itemDistrict.MaQH}
                                        value={itemDistrict.MaQH}
                                    >
                                        {itemDistrict.TenQH}
                                    </option>
                                ),
                    ...
                    <label className="font-bold ml-4" htmlFor="ward">
                        Ward{' '}
                    </label>
                    <div className="mb-2 w-92">
                        <select
                        ...
                        >
                            ...
                            {(listWard as TypeLocationWard[]).map(
                                (itemWard: TypeLocationWard) => (
                                    <option
                                        key={itemWard.MaXP}
                                        value={itemWard.MaXP}
                                    >
                    ...
                    <input
                        className="text-white hover:text-black py-2 mt-4 rounded-md px-8 bg-blue-600 focus:outline-none active:bg-pink-500 hover:bg-yellow-400"
                        type="submit"
                    />
                </div>
            </form>
