        ...
        <>
            ...
            <div className="mt-12 px-4 min-h-screen">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <Link to="/changePassword"><button className="bg-red-500 px-4 h-10 py-2 rounded-md outline-none focus:outline-none text-white hover:bg-red-400">{t('profile.changePassword')}</button></Link>
                </div>
