    ...
    return (
        <div className="animate-pulse relative w-56 sm:w-56 md:w-60 lg:w-56 xl:w-52 2xl:w-full h-96 bg-white rounded-md shadow-lg border border-gray-500 ">
            <div className="h-64 w-full">
                <img className="h-60 w-11/12 mx-auto mt-1 bg-gray-600" alt="image" />
            </div>
            ...
            <button className="bg-blue-600 active:bg-blue-400 focus:outline-none hover:bg-blue-800  px-12 py-5 z-20 rounded-md mt-2 font-semibold text-white" aria-hidden="true"></button>
        </div>
    )
}
